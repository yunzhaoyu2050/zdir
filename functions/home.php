					    ...
					    <tr id = "id<?php echo $i; ?>">
						    <td>
							    ...
							    <?php if(($suffix == 'jpg') || ($suffix == 'jpeg') || ($suffix == 'png') || ($suffix == 'gif') || ($suffix == 'bmp')){
							   	?>
							   	<a class = "fname1" href="<?php echo $url ?>" id = "url<?php echo $i; ?>" onmouseover = "showimg(<?php echo $i; ?>,'<?php echo $url; ?>')" onmouseout = "hideimg(<?php echo $i; ?>)"><i class="<?php echo $ico; ?>" style="color: #FFC827"></i> <?php echo $showdir; ?></a>
							   	<div class = "showimg" id = "show<?php echo $i; ?>"><img src="" id = "imgid<?php echo $i; ?>"></div>
							   	<!--如果是.exe文件-->
							   	<?php }elseif($zdir->is_exe($fullpath)){ ?>
									<a class = "fname1" href="<?php echo $url ?>" id = "url<?php echo $i; ?>"><i class="<?php echo $ico; ?>" style="color: #FFC827"></i> <?php echo $showdir; ?></a>
							   	<!--.exe文件END-->
							   	<?php }else{ ?>
							    <a class = "fname1" href="<?php echo $url ?>" id = "url<?php echo $i; ?>"><i class="<?php echo $ico; ?>" style="color: #FFC827"></i> <?php echo $showdir; ?></a>
							    <?php } ?>
